    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InternalMovieId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExternalMovieId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.InternalMovieId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreUser", x => new { x.FavoriteGenresGenreId, x.FavoritedByUsersId });
                    table.ForeignKey(
                        name: "FK_GenreUser_AspNetUsers_FavoritedByUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreUser_FavoritedByUsersId",
                table: "GenreUser",
